...
export function BottomNav() {
  ...
  return (
    <nav
      className="app-fixed-bar bottom-0 z-40 border-t border-surface-border bg-white [transform:translateZ(0)]"
      aria-label="하단 내비게이션"
    >
      <div className="flex w-full min-w-0 max-w-full items-stretch pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-1">
        {TABS.map((tab) => {
