  ...
  return (
    <div className="px-4 pt-4">
      <div className="overflow-hidden rounded-[18px]">
        <div
          className="scrollbar-hide flex h-[146px] snap-x snap-mandatory gap-[3px] overflow-x-auto overscroll-x-contain bg-[#E5E7EB]"
          style={{
        ...
        >
          {photos.map((photo, index) => (
            <div
              key={`${photo}-${index}`}
              className="h-full w-[132px] shrink-0 snap-start overflow-hidden"
            >
              <img
